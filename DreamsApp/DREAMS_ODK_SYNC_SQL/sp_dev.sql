...
-- update current age
UPDATE dreams_dev.flat_dreams_enrollment set current_age = DATEDIFF(CURDATE(), d.date_of_birth) DIV 365.25 where current_age != DATEDIFF(CURDATE(), d.date_of_birth) DIV 365.25 ;
