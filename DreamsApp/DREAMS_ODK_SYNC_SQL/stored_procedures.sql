...
DELETE FROM DreamsApp_intervention;
ALTER TABLE DreamsApp_intervention AUTO_INCREMENT=1;
...
-- ------------------------------------------------ create a flat table -------------------------------------------------------
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_create_flat_enrollment_table$$
CREATE PROCEDURE sp_create_flat_enrollment_table()
BEGIN
