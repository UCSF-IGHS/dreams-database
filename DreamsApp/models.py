...
class ClientIndividualAndHouseholdData(models.Model):
    ...
    client = models.ForeignKey(Client)
    head_of_household = models.ForeignKey(HouseholdHead)
    ...
    main_floor_material = models.ForeignKey(FloorMaterial, verbose_name='Main floor material', null=True)
    main_floor_material_other = models.CharField(max_length=50, verbose_name='Main floor material: other', blank=True, null=True)
    main_roof_material = models.ForeignKey(RoofingMaterial, verbose_name='Main roof material', null=True)
    main_roof_material_other = models.CharField(max_length=50, verbose_name='Main roof material: other', blank=True, null=True)
    main_wall_material = models.ForeignKey(RoofingMaterial, verbose_name='Main wall material', null=True)
    main_wall_material_other = models.CharField(max_length=50, verbose_name='Main wall material: other', blank=True,
                                                   null=True)
    source_of_drinking_water = models.ForeignKey(DrinkingWater, verbose_name='Main source of drinking water', null=True)
    source_of_drinking_water_other = models.CharField(max_length=50, verbose_name='Main source of drinking water: other', blank=True,
                                                   null=True)
    ever_missed_full_day_food_in_4wks = models.ForeignKey(CategoricalResponse, null=True)
    no_of_days_missed_food_in_4wks = models.ForeignKey(FrequencyResponse, blank=True)
    has_disability = models.ForeignKey(CategoricalResponse, verbose_name='Disabled?', blank=True, null=True)
    disability_type = models.ForeignKey(DisabilityType, null=True, blank=True, verbose_name='Disability Type')
    disability_type_other = models.CharField(verbose_name='Other disability type', blank=True, null=True)
    ...
    ever_enrolled_in_ct_program = models.ForeignKey(CategoricalResponse, verbose_name='Ever enrolled in Cash Transfer?')
    currently_in_ct_program = models.ForeignKey(CategoricalResponse, verbose_name="Currently enrolled in Cash Transfer?")
    current_ct_program = models.CharField(verbose_name='Cash Transfer Programme currently enrolled in')


class ClientEducationAndEmploymentData(models.Model):
    """ Holds education and employment information about Dreams client"""
    client = models.ForeignKey(Client)
    currently_in_school = models.ForeignKey(CategoricalResponse, verbose_name='Currently schooling')
    current_school_name = models.CharField(verbose_name='Name of school', blank=True, null=True)
    current_school_type = models.ForeignKey(SchoolType, verbose_name='Type of school', blank=True, null=True)
    current_school_level = models.ForeignKey(SchoolLevel, verbose_name='Current school level', null=True, blank=True)
    ...
    current_education_supporter = models.ManyToManyField(EducationSupporter, blank=True, null=True)
    ...
    reason_not_in_school = models.ForeignKey(ReasonNotInSchool, verbose_name='Reason for not going to school')
    reason_not_in_school_other = models.CharField(verbose_name='Reason for not going to school: other')
    last_time_in_school = models.ForeignKey(PeriodResponse, verbose_name='Last time in school')
    dropout_school_level = models.ForeignKey(SchoolLevel, 'In which class/form did you stop schooling?')
    dropout_class = models.CharField(max_length=15, verbose_name='Drop out class')
    life_wish = models.ForeignKey(LifeWish, verbose_name='Wish in life', blank=True, null=True)
    life_wish_other = models.CharField(verbose_name='Wish in life: other', max_length=50, blank=True, null=True)
    current_income_source = models.ForeignKey(SourceOfIncome, verbose_name='Current source of income')
    current_income_source_other = models.CharField(verbose_name='Source of income: other', max_length=30)
    has_savings = models.ForeignKey(CategoricalResponse, verbose_name='Do you have savings?')
    banking_place = models.ForeignKey(BankingPlace, verbose_name='Where do you keep your savings?', blank=True, null=True)
...
class ClientHIVTestingData(models.Model):
    ...
    client = models.ForeignKey(Client)
    ever_tested_for_hiv = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    period_last_tested = models.ForeignKey(PeriodResponse, blank=False , null=False)
    last_test_result = models.ForeignKey(HivTestResultResponse, blank=False, null=False)
    enrolled_in_hiv_care = models.ForeignKey(CategoricalResponse, blank=True, null=True)
    care_facility_enrolled = models.CharField(max_length=50, blank=True, null=False)
    reason_not_in_hiv_care = models.ForeignKey(ReasonNotInHIVCare, blank=True, null=True)
    reason_not_in_hiv_care_other = models.CharField(max_length=50, blank=True, null=True)
    knowledge_of_hiv_test_centres = models.ForeignKey(CategoricalResponse)
    reason_never_tested_for_hiv = models.ManyToManyField(ReasonNotTestedForHIV, blank=True, null=True)


class ClientSexualActivityData(models.Model):
    """ Holds Sexual activity information about a client"""
    client = models.ForeignKey(Client)
    ever_had_sex = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    age_at_first_sexual_encounter = models.IntegerField(verbose_name='Age at first sexual encounter')
    has_sexual_partner = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    sex_partners_in_last_12months = models.IntegerField(verbose_name='Sexual partners in the last 12 months', null=False)
    age_of_last_partner = models.ForeignKey(AgeOfSexualPartner, null=True, blank=True)
    age_of_second_last_partner = models.ForeignKey(AgeOfSexualPartner, null=True, blank=True)
    age_of_third_last_partner = models.ForeignKey(AgeOfSexualPartner, null=True, blank=True)
    last_partner_circumcised = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    second_last_partner_circumcised = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    third_last_partner_circumcised = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    know_last_partner_hiv_status = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    know_second_last_partner_hiv_status = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    know_third_last_partner_hiv_status = models.ForeignKey(CategoricalResponse, null=True, blank=True)
    used_condom_with_last_partner = models.ForeignKey(FrequencyResponse, null=True, blank=True)
    used_condom_with_second_last_partner = models.ForeignKey(FrequencyResponse, null=True, blank=True)
    used_condom_with_third_last_partner = models.ForeignKey(FrequencyResponse, null=True, blank=True)
    received_money_gift_for_sex = models.ForeignKey(CategoricalResponse, blank=True, null=True)


class ClientReproductiveHealthData(models.Model):
    """ Holds information about client's reproductivity """
    client = models.ForeignKey(Client)
    has_biological_children = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    no_of_biological_children = models.IntegerField(blank=True, null=True)
    currently_pregnant = models.ForeignKey(CategoricalResponse)
    current_anc_enrollment = models.ForeignKey(CategoricalResponse, blank=True, null=True)
    anc_facility_name = models.CharField(max_length=50, blank=True, null=True)
    fp_methods_awareness = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    known_fp_method = models.ManyToManyField(FamilyPlanningMethod,blank=True, null=True)
    known_fp_method_other = models.CharField(max_length=50, null=True, blank=True)
    currently_use_modern_fp = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    current_fp_method = models.ForeignKey(FamilyPlanningMethod, blank=True, null=True)
...
class ClientGenderBasedViolenceData(models.Model):
    ...
    client = models.ForeignKey(Client)
    humiliated_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    humiliated_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    threats_to_hurt_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    threats_to_hurt_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    insulted_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    insulted_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    economic_threat_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    economic_threat_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    physical_violence_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    physical_violence_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    physically_forced_sex_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    physically_forced_sex_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    physically_forced_other_sex_acts_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    physically_forced_other_sex_acts_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    threatened_for_sexual_acts_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False)
    threatened_for_sexual_acts_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=False)
    seek_help_after_gbv = models.ForeignKey(CategoricalResponse, blank=True, null=False)
    gbv_help_provider = models.ManyToManyField(GBVHelpProvider, blank=True, null=True)
    gbv_help_provider_other = models.CharField(max_length=50, verbose_name='Other source of GBV help')
    knowledge_of_gbv_help_centres = models.ForeignKey(CategoricalResponse, blank=True, null=True)
    preferred_gbv_help_provider = models.ManyToManyField(GBVHelpProvider,blank=True, null=True)
...
class ClientDrugUseData(models.Model):
    ...
    client = models.ForeignKey(Client)
    used_alcohol_last_12months = models.ForeignKey(CategoricalResponse)
    frequency_of_alcohol_last_12months = models.ForeignKey(FrequencyResponse)
    drug_abuse_last_12months = models.ForeignKey(CategoricalResponse)
    drug_abuse_last_12months_other = models.CharField(max_length=50, blank=True, null=True)
    drug_used_last_12months = models.ManyToManyField(Drug, null=True)
    drug_used_last_12months_other = models.CharField(max_length=50, blank=True, null=True)
    produced_alcohol_last_12months = models.ForeignKey(CategoricalResponse)
...
class ClientParticipationInDreams(models.Model):
    ...
    dreams_program = models.ManyToManyField(DreamsProgramme,blank=True, null=True)
