...
class ClientGenderBasedViolenceData(models.Model):
    ...
    humiliated_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    threats_to_hurt_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    threats_to_hurt_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    insulted_ever = models.ForeignKey(CategoricalResponse, blank=False, null=False, related_name='+')
    insulted_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    economic_threat_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    economic_threat_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    physical_violence_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    physical_violence_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    physically_forced_sex_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    physically_forced_sex_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    physically_forced_other_sex_acts_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    physically_forced_other_sex_acts_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
    threatened_for_sexual_acts_ever = models.ForeignKey(CategoricalResponse, blank=False, null=True, related_name='+')
    threatened_for_sexual_acts_last_3months = models.ForeignKey(FrequencyResponse, blank=False, null=True, related_name='+')
