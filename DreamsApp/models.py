...
class ImplementingPartner(models.Model):
    ...
    implementing_partner_funder = models.ForeignKey(ImplementingPartnerFunder, on_delete=models.PROTECT, null=True,
                                                    blank=True, verbose_name='Funder')
...
class Client(models.Model):
    first_name = models.CharField(verbose_name='First Name', max_length=250, null=True, blank=True, db_index=True)
    middle_name = models.CharField(verbose_name='Middle Name', max_length=250, null=True, blank=True, db_index=True)
    last_name = models.CharField(verbose_name='Last Name', max_length=250, null=True, blank=True, db_index=True)
    ...
    dreams_id = models.CharField(verbose_name='DREAMS ID', max_length=250, null=True, blank=True, db_index=True)
    guardian_name = models.CharField(verbose_name='Primary Care Giver/Guardian\' Name', max_length=250, null=True, blank=True)
    relationship_with_guardian = models.CharField(verbose_name='Relationship with Guardian', max_length=250, null=True, blank=True)
