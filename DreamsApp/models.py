...
class Client(models.Model):
    ...
    verification_doc_no = models.CharField(verbose_name='Verification Doc. No.', max_length=255, null=True)
    date_of_enrollment = models.DateField(verbose_name='Date of Enrollment', default=datetime.now, null=True)
    age_at_enrollment = models.IntegerField(verbose_name='Age at Enrollment', default=255, null=True)
    ...
    phone_number = models.CharField(verbose_name='Phone Number(Client)', max_length=255, null=True)
    dss_id_number = models.CharField(verbose_name='DSS ID Number', max_length=255, null=True)
    ...
    informal_settlement = models.CharField(verbose_name='Informal Settlement', max_length=255, null=True)
    village = models.CharField(verbose_name='Village', max_length=255, null=True)
    landmark = models.CharField(verbose_name='Land mark near residence', max_length=255, null=True)
    dreams_id = models.CharField(verbose_name='DREAMS ID', max_length=255, null=True)
    guardian_name = models.CharField(verbose_name='Primary care give / Guardian\' name', max_length=255, null=True)
    relationship_with_guardian = models.CharField(verbose_name='Relationship with Guardian', max_length=255, null=True)
    guardian_phone_number = models.CharField(verbose_name='Phone Number(Care giver / Guardian)', max_length=255, null=True)
    guardian_national_id = models.CharField(verbose_name='National ID (Care giver / Guardian)', max_length=255, null=True)
...
class ClientIndividualAndHouseholdData(models.Model):
    ...
    head_of_household_other = models.CharField(max_length=255, blank=True, null=True)
    ...
    main_floor_material = models.ForeignKey(FloorMaterial, verbose_name='Main floor material', null=True,
                                            related_name='+')
    main_floor_material_other = models.CharField(max_length=255, verbose_name='Main floor material: other', blank=True,
                                                 null=True)
    main_roof_material = models.ForeignKey(RoofingMaterial, verbose_name='Main roof material', null=True,
                                           related_name='+')
    main_roof_material_other = models.CharField(max_length=255, verbose_name='Main roof material: other', blank=True,
                                                null=True)
    main_wall_material = models.ForeignKey(WallMaterial, verbose_name='Main wall material', null=True, related_name='+')
    main_wall_material_other = models.CharField(max_length=255, verbose_name='Main wall material: other', blank=True,
                                                null=True)
    source_of_drinking_water = models.ForeignKey(DrinkingWater, verbose_name='Main source of drinking water', null=True,
                                                 related_name='+')
    source_of_drinking_water_other = models.CharField(max_length=255,
                                                      verbose_name='Main source of drinking water: other', blank=True,
                                                      null=True)
    ...
    disability_type_other = models.CharField(verbose_name='Other disability type', blank=True, null=True,
                                             max_length=255)
    no_of_people_in_household = models.IntegerField(verbose_name='No of people living in your house', null=True,
                                                    blank=True)
    ...
    ever_enrolled_in_ct_program = models.ForeignKey(CategoricalResponse, null=True,
                                                    verbose_name='Ever enrolled in Cash Transfer?', related_name='+')
    currently_in_ct_program = models.ForeignKey(CategoricalResponse, null=True,
                                                verbose_name="Currently enrolled in Cash Transfer?", related_name='+')
    current_ct_program = models.CharField(verbose_name='Cash Transfer Programme currently enrolled in', max_length=255,
                                          null=True)
...
class ClientEducationAndEmploymentData(models.Model):
    ...
    client = models.ForeignKey(Client)
    currently_in_school = models.ForeignKey(CategoricalResponse, null=True, verbose_name='Currently schooling',
                                            related_name='+')
    current_school_name = models.CharField(verbose_name='Name of school', blank=True, null=True, max_length=255)
    ...
    current_school_level = models.ForeignKey(SchoolLevel, verbose_name='Current school level', null=True, blank=True,
                                             related_name='+')
    current_class = models.CharField(verbose_name='Class', max_length=255, blank=True, null=True)
    current_school_level_other = models.CharField(verbose_name='Other Education Level', max_length=255, blank=True,
                                                  null=True)
    current_education_supporter = models.ManyToManyField(EducationSupporter, blank=True)
    current_education_supporter_other = models.CharField(max_length=255, null=True, blank=True,
                                                         verbose_name='Support towards current education: other')
    reason_not_in_school = models.ForeignKey(ReasonNotInSchool, null=True,
                                             verbose_name='Reason for not going to school', related_name='+')
    reason_not_in_school_other = models.CharField(verbose_name='Reason for not going to school: other', max_length=255,
                                                  null=True)
    last_time_in_school = models.ForeignKey(PeriodResponse, null=True, verbose_name='Last time in school',
                                            related_name='+')
    dropout_school_level = models.ForeignKey(SchoolLevel, related_name='+', null=True)
    dropout_class = models.CharField(max_length=255, verbose_name='Drop out class', null=True)
    life_wish = models.ForeignKey(LifeWish, verbose_name='Wish in life', blank=True, null=True, related_name='+')
    life_wish_other = models.CharField(verbose_name='Wish in life: other', max_length=255, blank=True, null=True)
    current_income_source = models.ForeignKey(SourceOfIncome, null=True, verbose_name='Current source of income',
                                              related_name='+')
    current_income_source_other = models.CharField(verbose_name='Source of income: other', max_length=255, null=True)
    has_savings = models.ForeignKey(CategoricalResponse, null=True, verbose_name='Do you have savings?',
                                    related_name='+')
    banking_place = models.ForeignKey(BankingPlace, verbose_name='Where do you keep your savings?', blank=True,
                                      null=True, related_name='+')
    banking_place_other = models.CharField(max_length=255, verbose_name='Other place for savings', null=True)
...
class ClientHIVTestingData(models.Model):
    ...
    care_facility_enrolled = models.CharField(max_length=255, blank=True, null=True)
    reason_not_in_hiv_care = models.ForeignKey(ReasonNotInHIVCare, blank=True, null=True, related_name='+')
    reason_not_in_hiv_care_other = models.CharField(max_length=255, blank=True, null=True)
    ...
    reason_never_tested_for_hiv_other = models.CharField(max_length=255, blank=True, null=True)
...
class ClientReproductiveHealthData(models.Model):
    ...
    anc_facility_name = models.CharField(max_length=255, blank=True, null=True)
    ...
    known_fp_method_other = models.CharField(max_length=255, null=True, blank=True)
    ...
    current_fp_method_other = models.CharField(max_length=255, verbose_name='Other Modern FP method used',
                                                       blank=True, null=True)
    reason_not_using_fp = models.ForeignKey(ReasonNotUsingFamilyPlanning, null=True, blank=True, related_name='+')
    reason_not_using_fp_other = models.CharField(max_length=255, blank=True, null=True)
...
class ClientGenderBasedViolenceData(models.Model):
    ...
    gbv_help_provider_other = models.CharField(max_length=255, verbose_name='Other source of GBV help', null=True)
    ...
    preferred_gbv_help_provider_other = models.CharField(max_length=255, blank=True, null=True)
...
class ClientDrugUseData(models.Model):
    ...
    drug_abuse_last_12months_other = models.CharField(max_length=255, blank=True, null=True)
    drug_used_last_12months = models.ManyToManyField(Drug)
    drug_used_last_12months_other = models.CharField(max_length=255, blank=True, null=True)
...
class ClientParticipationInDreams(models.Model):
    ...
    client = models.ForeignKey(Client)
    dreams_program_other = models.CharField(max_length=255, blank=True, null=True)
