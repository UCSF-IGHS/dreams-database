...
SELECT
  provider.clientgenderbasedviolencedata_id AS rec_id,
  group_concat(provider.gbvhelpprovider_id) AS provider_list
FROM DreamsApp_clientgenderbasedviolencedata_preferred_gbv_help_provider provider
GROUP BY rec_id
...
FROM DreamsApp_clienteducationandemploymentdata_current_education_supporter s
GROUP BY rec_id
