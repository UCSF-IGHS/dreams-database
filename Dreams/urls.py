...
urlpatterns = [
    ...
    url(r'^get-client-transfers-count$', views.get_pending_client_transfers_count, name='get_pending_client_transfers_count'),
    url(r'^get-client-referrals-count$', views.get_pending_client_referrals_count, name='get_pending_client_referrals_count'),
