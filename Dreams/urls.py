...
urlpatterns = [
    ...
    url(r'^download-service-layering-report/$', views.downloadIndividualLayeringReport),
    ...
    url(r'^download-intervention-transferred-in-report/$', views.download_raw_intervention_transferred_in_report,
