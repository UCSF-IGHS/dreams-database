...
urlpatterns = [
    ...
    path('admin/users/save', views.save_user, name='new user'),
    path('admin/users/change_cred', views.change_cred, name='change_cred'),
    path('admin/users/toggle_status', views.toggle_status, name='toggle_user_status'),
    ...
    path('client-transfers/(?P<transferred_in>[0-1])', views.ClientTransfesListView.as_view(), name='client_transfers'),
    path('client-referrals/(?P<referred_in>[0-1])', views.ClientReferralsListView.as_view(), name='client_referrals'),
    ...
    path('export-client-transfers/(?P<transferred_in>[0-1])', views.export_client_transfers,
        name='export_client_transfers'),
    path('export-client-referrals/(?P<referred_in>[0-1])', views.export_client_referrals,
